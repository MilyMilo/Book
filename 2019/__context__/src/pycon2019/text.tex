...
\ListaPlac Komitet Programowy:
 Joanna Truszkowska (przewodnicząca)
 Mateusz Bełczowski
 Radosław Ganczarek
 Dawid Fajkowski
 Paweł Kopka
...
\centerline{\externalfigure[src/pycon2019/psf.png][width=0.45\hsize]}

\ListaPlac Złoci Sponsorzy:~\par%\blank[2*big]
\centerline{}
\centerline{\externalfigure[src/pycon2019/redhat.png][width=0.45\hsize]}

\ListaPlac Srebrni Sponsorzy:\par
\vskip12mm
\centerline{\externalfigure[src/pycon2019/merix.png][width=0.40\hsize]\hskip12mm\externalfigure[src/pycon2019/evident.png][width=0.40\hsize]}
\vskip12mm
\centerline{\externalfigure[src/pycon2019/jetbrains.png][width=0.35\hsize]}

\ListaPlac Brązowi Sponsorzy:\par
\vskip12mm
\centerline{\externalfigure[src/pycon2019/netguru.png][width=0.40\hsize]}
...
Witamy na dwunastej edycji konferencji PyCon PL!

Nasze wydarzenie gości w tym roku w Hotelu Villa Verde w Zawierciu.

Na koniec tego wstępniaka, już tradycyjnie pozostaje sobie życzyć dobrze
spędzonego czasu, udanej integracji i sporo wyniesionej wiedzy na PyCon PL 2019.
...
zostały wykonane wyłącznie w~systemie Linux (m.in. Ubuntu 18.04.1 LTS).
