...
1. [http://behave.readthedocs.io/en/latest/](http://behave.readthedocs.io/en/latest/)
2. [https://en.wikipedia.org/wiki/Behavior-driven_development](https://en.wikipedia.org/wiki/Behavior-driven_development)
3. [https://en.wikipedia.org/wiki/Continuous_integration](https://en.wikipedia.org/wiki/Continuous_integration)
4. [https://en.wikipedia.org/wiki/Operational_acceptance_testing](https://en.wikipedia.org/wiki/Operational_acceptance_testing)
5. [http://selenium-python.readthedocs.io/](http://selenium-python.readthedocs.io/)
6. [http://docs.behat.org/en/v2.5/guides/1.gherkin.html](http://docs.behat.org/en/v2.5/guides/1.gherkin.html)
7. _BDD in Action_ - John Ferguson Smart
8. _Specification by Example: How Successful Teams Deliver the Right Software_ - Gojko Adzic
9. _Testuj oprogramowanie jak Google. Metody automatyzacji_ - James A. Whittaker, Jason Arbon, Jeff Carollo
